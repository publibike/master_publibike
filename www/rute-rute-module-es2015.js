...
/* harmony import */ var _services_api_publibike_marca_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../services/api-publibike-marca.service */ "Q5Ll");
...
let RutePage = class RutePage {
    constructor(apiService, storage, loadingCtrl, backgroundMode) {
    ...
    initializedMap() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            try {
                const [Map, MapView, Graphic, RouteTask, RouteParameters, FeatureSet, Directions, Locate, Track, Locator, LocatorSearchSource, Expand, Point, Draw, geometryEngine, FeatureLayer, DistanceMeasurement2DViewModel] = yield Object(esri_loader__WEBPACK_IMPORTED_MODULE_6__["loadModules"])([
                    'esri/Map',
                    'esri/views/MapView',
                    "esri/Graphic",
    ...
    ionViewWillEnter() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            this.user = yield this.apiService.getUserData(user._id);
            this.initializedMap()
...
RutePage.propDecorators = {
    ...
    basemap: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["Input"] }]
};
