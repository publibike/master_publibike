...
assert( MONGO_DATABASE1, "MONGO_DATABASE configuration is required." );
assert( MONGO_DATABASE2, "MONGO_DATABASE configuration is required." );
...
module.exports = {
    ...
    mongo: {
        server: MONGO_SERVER,
        database1: MONGO_DATABASE1,
        database2: MONGO_DATABASE2,
        user: MONGO_USER,
